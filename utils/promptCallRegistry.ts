...
export const CALL_REGISTRY: CallSite[] = [
    // ── 主聊天链路 10 ──
    { site: 'chat-main', category: '主聊天链路', name: '主聊天请求', blurb: 'useChatAI 主请求 + 重试 + 工具轮续跑', trigger: '发送前', sources: ['chat.steelExpression', 'chat.steelYourself', 'voice.minimax', 'voice.fish', 'voice.elevenlabsV3', 'voice.elevenlabsStd', 'chat.perspectiveTool'], gates: [G.api], visibility: 'local', anchor: 'hooks/useChatAI.ts:1071', pin: 'baseReqBody' },
