...
| 📝 **预设** | 提示词段落预设管理（含预设合集），提示词目录的三段式标签与注入预览也在此体系 |
...
| 🏦 **存钱罐** | 银行拟真：21 家银行/卡组织真实卡面与品牌渐变、角色名下卡与只读流水、外卖/购物/点单全进同一套账本 |
| 🍔 **外卖** | 美团式点单：真实店铺（OpenStreetMap）+ 品牌 SKU 菜单，购物车/结账/订单全流程，可给自己或角色点 |
| 🛍️ **购物** | 淘宝式浏览：真实商品（OpenFoodFacts 中国区），店铺搜索与跨店搜索，下单扣卡进账本 |
| 📓 **交换日记** | 角色会偷偷写关于你的事，可能写你坏话 |
| 🔥 **Spark** | 社交媒体模拟，角色会发动态 |
| 📚 **自习室** | 专注学习模式，让角色监督你学习；内含 EPUB 阅读器（原文/AI 总结双模式）与讲课模式 |
| 🍅 **番茄钟** | 水球计时 + 同伴鼓励与惩罚（落聊天和记忆）、可拖动悬浮球、12 周热力图，铅笔手绘风 |
| 🔮 **塔罗** | 每日一抽与多种牌阵（时间之流/十字/关系/马蹄/凯尔特十字），78 张韦特牌库，本地速览 + 按需让角色解读 |
| 🎮 **TRPG** | 跑团模式，掷骰子冒险 |
...
| 🎧 **音乐** | 接网易云 API + 酷狗概念版 API（默认音源酷狗，设置里可切），搜歌 / 听歌 / 看歌词 / 歌单 / 每日推荐。角色会"一起听"，背景音的歌词会注进它的精神世界，让它顺着歌聊天（不是每句都尬评，放心）|
| ⚙️ **设置** | API、网络代理、云备份、导出导入，都在这 |
| 💻 **终端** | 手机远程控制台：连电脑上自己跑的 opencode 服务，看会话、传文件、遥控执行 |
